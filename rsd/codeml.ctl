      seqfile = datafile.seq * sequence data filename
      outfile = outfile.seq           * main result file name
     treefile = treefile.seq      * tree structure file name
   ...
   aaRatefile = jones.dat * only used for aa seqs with model=empirical(_F)
    ...
    fix_alpha = 1  * 0: estimate gamma shape parameter; 1: fix it at alpha
        alpha = 1.53 * initial or fixed alpha, 0:infinity (constant rate)
